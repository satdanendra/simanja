            ...
            <form id="createTimForm" action="{{ route('tims.store') }}" class="relative bg-white rounded-lg shadow-lg dark:bg-gray-700" method="POST">
                ...
                <div class="p-6 space-y-6">
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <!-- Ketua Tim -->
                        <div>
                            <label for="tim_ketua" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Ketua Tim</label>
                            <select name="tim_ketua" id="tim_ketua" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" required>
