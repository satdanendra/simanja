<x-app-layout>
    ...
    <div id="createTimModal" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 items-center justify-center hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative w-full max-w-2xl max-h-full">
            <!-- Modal content -->
            <form id="createTimForm" action="{{ route('tims.store') }}" class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700" method="POST">
                @csrf
                <!-- Modal header -->
                <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600 border-gray-200">
                    <h3 class="text-xl font-semibold text-gray-900 dark:text-white">
                    ...
                    <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="createTimModal">
                        <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
                        </svg>
                        <span class="sr-only">Close modal</span>
                ...
                <div class="p-6 space-y-4">
                    <div class="grid grid-cols-6 gap-4">
                        ...
                        <div class="col-span-6">
                            <label for="eselon_1" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Eselon 1</label>
                            <select name="eselon_1" id="eselon_1" class="shadow-xs bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                                <option value="">-- Pilih Eselon 1 --</option>
                                <option value="Sekretariat Utama">Sekretariat Utama</option>
                                <option value="Deputi Bidang Metodologi dan Informasi Statistik">Deputi Bidang Metodologi dan Informasi Statistik</option>
                                <option value="Deputi Bidang Statistik Sosial">Deputi Bidang Statistik Sosial</option>
                                <option value="lainnya">Lainnya</option>
                            </select>
                        </div>
                        
                        <!-- Eselon 1 Lainnya (hidden by default) -->
                        <div id="eselon_1_lainnya_container" class="col-span-6 hidden">
                            <label for="eselon_1_lainnya" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Eselon 1 Lainnya</label>
                            <input type="text" name="eselon_1_lainnya" id="eselon_1_lainnya" class="shadow-xs bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan nama Eselon 1">
                        </div>
                        
                        <!-- Eselon 2 -->
                        <div class="col-span-6">
                            <label for="eselon_2" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Eselon 2</label>
                            <select name="eselon_2" id="eselon_2" class="shadow-xs bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                                <option value="">-- Pilih Eselon 2 --</option>
                                <option value="Direktorat Pengembangan Metodologi Sensus dan Survei">Direktorat Pengembangan Metodologi Sensus dan Survei</option>
                                <option value="Direktorat Diseminasi Statistik">Direktorat Diseminasi Statistik</option>
                                <option value="Direktorat Sistem Informasi Statistik">Direktorat Sistem Informasi Statistik</option>
                                <option value="lainnya">Lainnya</option>
                            </select>
                        </div>
                        
                        <!-- Eselon 2 Lainnya (hidden by default) -->
                        <div id="eselon_2_lainnya_container" class="col-span-6 hidden">
                            <label for="eselon_2_lainnya" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Eselon 2 Lainnya</label>
                            <input type="text" name="eselon_2_lainnya" id="eselon_2_lainnya" class="shadow-xs bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan nama Eselon 2">
                        </div>
                        
                        <!-- Eselon 3 -->
                        <div class="col-span-6">
                            <label for="eselon_3" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Eselon 3</label>
                            <select name="eselon_3" id="eselon_3" class="shadow-xs bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                                <option value="">-- Pilih Eselon 3 --</option>
                                <option value="BPS Kota Magelang">BPS Kota Magelang</option>
                                <option value="lainnya">Lainnya</option>
                            </select>
                        </div>
                        
                        <!-- Eselon 3 Lainnya (hidden by default) -->
                        <div id="eselon_3_lainnya_container" class="col-span-6 hidden">
                            <label for="eselon_3_lainnya" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Eselon 3 Lainnya</label>
                            <input type="text" name="eselon_3_lainnya" id="eselon_3_lainnya" class="shadow-xs bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan nama Eselon 3">
                        </div>
                        
                        <!-- Tahun -->
                        <div class="col-span-3">
                            <label for="tahun" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tahun</label>
                            <input type="text" name="tahun" id="tahun" class="shadow-xs bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="2025" required>
                        </div>
                        
                        <!-- Kode Tim -->
                        <div class="col-span-3">
                            <label for="kode_tim" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kode Tim</label>
                            <input type="text" name="kode_tim" id="kode_tim" class="shadow-xs bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="T01" required>
                        </div>
                        
                        <!-- Nama Tim -->
                        <div class="col-span-6">
                            <label for="nama_tim" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Tim</label>
                            <select name="nama_tim" id="nama_tim" class="shadow-xs bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                        ...
                        <!-- Nama Tim Lainnya (hidden by default) -->
                        <div id="nama_tim_lainnya_container" class="col-span-6 hidden">
                            <label for="nama_tim_lainnya" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Tim Lainnya</label>
                            <input type="text" name="nama_tim_lainnya" id="nama_tim_lainnya" class="shadow-xs bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan nama tim">
                        </div>
                        
                        <!-- Ketua Tim -->
                        <div class="col-span-6">
                            <label for="ketua_tim" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Ketua Tim</label>
                            <select name="ketua_tim" id="ketua_tim" class="shadow-xs bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                ...
                <div class="flex items-center p-6 space-x-3 rtl:space-x-reverse border-t border-gray-200 rounded-b dark:border-gray-600">
                    <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Simpan</button>
                    <button type="button" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600" data-modal-hide="createTimModal">Batal</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            // Fungsi untuk menangani opsi "Lainnya" di dropdown
            function setupLainnyaField(selectId, containerId) {
            ...
            // Setup untuk semua dropdown dengan opsi "Lainnya"
            setupLainnyaField("eselon_1", "eselon_1_lainnya_container");
            setupLainnyaField("eselon_2", "eselon_2_lainnya_container");
            setupLainnyaField("eselon_3", "eselon_3_lainnya_container");
            setupLainnyaField("nama_tim", "nama_tim_lainnya_container");
            
            // Validasi form sebelum submit
            const createTimForm = document.getElementById("createTimForm");
            createTimForm.addEventListener("submit", function(event) {
                // Validasi pilihan "Lainnya"
                const fields = [
                    { select: "eselon_1", input: "eselon_1_lainnya" },
                    { select: "eselon_2", input: "eselon_2_lainnya" },
                    { select: "eselon_3", input: "eselon_3_lainnya" },
                    { select: "nama_tim", input: "nama_tim_lainnya" }
                ];
            ...
            // Filter opsi Eselon 2 berdasarkan pilihan Eselon 1
            const eselon1Select = document.getElementById("eselon_1");
            const eselon2Select = document.getElementById("eselon_2");
            
            eselon1Select.addEventListener("change", function() {
                // Reset opsi Eselon 2
                eselon2Select.innerHTML = '<option value="">-- Pilih Eselon 2 --</option>';
                
                // Tambahkan opsi berdasarkan pilihan Eselon 1
                if (this.value === "Sekretariat Utama") {
                    const options = [
                        "Biro Perencanaan",
                        "Biro Keuangan",
                        "Biro SDM",
                    ...
                    options.forEach(option => {
                        ...
                        eselon2Select.appendChild(optElement);
                    });
                } else if (this.value === "Deputi Bidang Metodologi dan Informasi Statistik") {
                    const options = [
                ...
                } else if (this.value === "Deputi Bidang Statistik Sosial") {
                    const options = [
                ...
                eselon2Select.appendChild(lainnya);
            });
        });
    </script>
