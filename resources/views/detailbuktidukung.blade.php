                                    ...
                                    <div class="p-4">
                                        ...
                                        <div class="flex items-center justify-between mt-4">
                                            ...
                                            <div class="flex space-x-2">
                                                <a href="{{ route('rinciankegiatan.bukti-dukung.view', $buktiDukung->id) }}" target="_blank" class="p-2 text-blue-600 dark:text-blue-400 hover:bg-blue-100 dark:hover:bg-blue-900 rounded-md" title="Lihat">
                                                ...
                                                <a href="{{ route('rinciankegiatan.bukti-dukung.download', $buktiDukung->id) }}" class="p-2 text-green-600 dark:text-green-400 hover:bg-green-100 dark:hover:bg-green-900 rounded-md" title="Download">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
                                                    </svg>
                                                </a>
                                                
                                                <form action="{{ route('rinciankegiatan.bukti-dukung.destroy', $buktiDukung->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus bukti dukung ini?')" class="inline-block">
                                                    @csrf
                                                    @method('DELETE')
